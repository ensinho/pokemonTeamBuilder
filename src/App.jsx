...
// Extracted modules
import { PATCH_NOTES_VERSION, THEMES, THEME_META, applyTheme } from './constants/theme';
...
import {
    GithubIcon, LinkedinIcon, StarsIcon, TrashIcon, ClearIcon, SaveIcon,
    MenuIcon, CloseIcon, PokeballIcon, SavedTeamsIcon,
    CollapseLeftIcon, CollapseRightIcon, ShareIcon,
    SuccessToastIcon, ErrorToastIcon, WarningToastIcon, SunIcon, MoonIcon,
    SwordsIcon, EditIcon, ShowdownIcon, DiceIcon,
...
import { AuthModal, ConfirmDialog, GreetingPokemonSelectorModal, PatchNotesModal, PokemonDetailModal, ShareSnippetModal, SyncPromptModal, TeamPokemonEditorModal } from './components/modals';
import { PageGuide, pageGuideTips } from './components/PageGuide';
import {
    AdminDashboardView,
    AllTeamsView,
