...
const BATTLE_ABILITIES = [
    ...
    { value: 'mega-launcher', label: 'Mega Launcher' },
    { value: 'punk-rock', label: 'Punk Rock' },
    { value: 'sand-force', label: 'Sand Force' },
    { value: 'hustle', label: 'Hustle' },
    { value: 'gorilla-tactics', label: 'Gorilla Tactics' },
    { value: 'solar-power', label: 'Solar Power' },
    { value: 'orichalcum-pulse', label: 'Orichalcum Pulse' },
    { value: 'hadron-engine', label: 'Hadron Engine' },
    ...
    { value: 'neuroforce', label: 'Neuroforce' },
    ...
    { value: 'toxic-boost', label: 'Toxic Boost' },
    { value: 'flare-boost', label: 'Flare Boost' },
    { value: 'analytic', label: 'Analytic' },
    { value: 'supreme-overlord', label: 'Supreme Overlord' },
    { value: 'slow-start', label: 'Slow Start' },
    { value: 'defeatist', label: 'Defeatist' },
    ...
    { value: 'grass-pelt', label: 'Grass Pelt' },
    ...
    { value: 'purifying-salt', label: 'Purifying Salt' },
    { value: 'bulletproof', label: 'Bulletproof' },
    { value: 'soundproof', label: 'Soundproof' },
    { value: 'wonder-guard', label: 'Wonder Guard' },
    { value: 'levitate', label: 'Levitate' },
    { value: 'earth-eater', label: 'Earth Eater' },
    { value: 'well-baked-body', label: 'Well-Baked Body' },
    { value: 'water-absorb', label: 'Water Absorb' },
    { value: 'volt-absorb', label: 'Volt Absorb' },
    { value: 'lightning-rod', label: 'Lightning Rod' },
    { value: 'motor-drive', label: 'Motor Drive' },
    { value: 'storm-drain', label: 'Storm Drain' },
    { value: 'sap-sipper', label: 'Sap Sipper' },
    { value: 'tablets-of-ruin', label: 'Tablets of Ruin' },
    { value: 'sword-of-ruin', label: 'Sword of Ruin' },
    { value: 'vessel-of-ruin', label: 'Vessel of Ruin' },
    { value: 'beads-of-ruin', label: 'Beads of Ruin' },
];
